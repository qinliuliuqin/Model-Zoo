...
__C.general.imseg_list = '/shenlab/lab_stor6/projects/CT_Dental/ThreeLabels/datasets/train.txt'

# the output of training models and logs
__C.general.save_dir = '/shenlab/lab_stor6/qinliu/CT_Dental/models/model_0610_2020'

# the model scale
__C.general.model_scale = 'fine'

# continue training from certain epoch, -1 to train from scratch
__C.general.resume_epoch = 3400
...
__C.dataset.crop_size = [160, 160, 160]
...
__C.loss.obj_weight = [1/4, 1/4, 1/3, 1/3]
