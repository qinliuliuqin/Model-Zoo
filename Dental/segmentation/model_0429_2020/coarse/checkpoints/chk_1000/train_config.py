...
__C.general.save_dir = '/shenlab/lab_stor6/qinliu/CT_Dental/models/model_0429_2020/coarse_seg_2.0'

# continue training from certain epoch, -1 to train from scratch
__C.general.resume_epoch = 100
...
__C.dataset.random_translation = [10, 10, 10]
