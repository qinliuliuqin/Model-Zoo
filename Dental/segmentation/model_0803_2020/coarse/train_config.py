...
__C.general.save_dir = '/home/admin/test/T4.0/Medical-Segmentation3d-Toolkit/models/model_0731_dental_2'
...
__C.dataset.spacing =[2.0, 2.0, 2.0] #[0.4, 0.4, 0.4] #[0.8, 0.8, 0.8] # 

# the sampling crop size, e.g., determine the context information
__C.dataset.crop_size = [96, 96, 96] #[128, 128, 128] #[80, 80, 80] #
