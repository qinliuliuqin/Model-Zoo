...
__C.general.imseg_list = '/shenlab/lab_stor6/projects/CT_Dental/dataset/segmentation/face/train_server.txt'

# the output of training models and logs
__C.general.save_dir = '/shenlab/lab_stor6/qinliu/CT_Dental/models/model_1115_2020'
...
__C.dataset.spacing = [0.3, 0.3, 0.3]
